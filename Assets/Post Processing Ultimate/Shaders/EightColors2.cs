...
{
	[Serializable]
	[PostProcess(typeof(EightColors2Renderer), PostProcessEvent.AfterStack, "NTEC/Screen/EightColors2")]
	...
	public sealed class EightColors2Renderer : PostProcessEffectRenderer<EightColors2>
	{
		...
		{
			var sheet = context.propertySheets.Get(Shader.Find("NTEC/Screen/EightColors2"));
